...
class LinkPathConstructor:
    ...
    def construct_link_path(self, parser: OPFParser, matched_format: str) -> str:
        """
        ...
        """
        if (title := parser.get_title()) is None:
            return None
        ...
        directory_name = series if series is not None else title
        ...
        if series_index or series_index == 0:
